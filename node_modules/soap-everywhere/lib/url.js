...
function urlParse(url, parseQueryString, slashesDenoteHost) {
  ...
  if (
    !hostlessProtocol[proto] && (slashes || (proto && !slashedProtocol[proto]))
  ) {
    // there's a hostname.
...
function urlFormat(obj) {
  ...
  if (
    obj.slashes || ((!protocol || slashedProtocol[protocol]) && host !== false)
  ) {
    host = "//" + (host || "");
...
function urlResolveObject(source, relative) {
  ...
  var isSourceAbs = source.pathname && source.pathname.charAt(0) === "/",
    isRelAbs = relative.host !== undefined ||
  ...
  var hasTrailingSlash = ((source.host || relative.host) &&
    (last === "." || last === "..")) ||
    last === "";
